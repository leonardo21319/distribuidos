...
class AdministradorTrafico {
  ...
  static class Worker_1 extends Thread {
    ...
    public void run() {
      try {
        // Se conecta al primer servidor (Servidor-1)
        cliente_2 = new Socket(host_remoto_1, puerto_remoto_1);

        // Thread que dirige el tráfico del host remoto (Servidor-1) al cliente
        ...
        // Leer los datos del cliente y reenviarlos al servidor remoto (Servidor-1)
  ...
  static class Worker_2 extends Thread {
    ...
    public void run() {
      try {
        ...
        // Leer los datos del servidor remoto (Servidor-1) y reenviarlos al cliente
